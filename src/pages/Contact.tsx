                  ...
                  <Card className="p-6 hover:shadow-card-sustainable transition-all duration-300 group">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <a href="mailto:contact@crmconseil.com" className="text-primary hover:underline">
                  ...
                  <Card className="p-6 hover:shadow-card-sustainable transition-all duration-300 group">
                    <div className="flex items-center space-x-4">
                      <div className="bg-commercial-light p-3 rounded-lg group-hover:scale-110 transition-transform">
                        <Phone className="text-commercial" size={24} />
                      </div>
                      <div>
                        <h3 className="font-semibold text-lg">Téléphone</h3>
                        <a href="tel:+33622953137" className="text-primary hover:underline">
                          +33 6 22 95 31 37
                        </a>
                      </div>
                    </div>
                  ...
                  <Card className="p-6 hover:shadow-card-sustainable transition-all duration-300 group">
                    <div className="flex items-center space-x-4">
                      <div className="bg-sustainable-light p-3 rounded-lg group-hover:scale-110 transition-transform">
                        <User className="text-sustainable" size={24} />
                      </div>
                      <div>
                        <h3 className="font-semibold text-lg">Consultante</h3>
                        <p className="text-muted-foreground">Sabrina Broggini</p>
                  ...
                  <Card className="p-6 hover:shadow-card-sustainable transition-all duration-300 group">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">France & International</p>
                        <p className="text-sm text-muted-foreground">Basée sur la Côte d'Azur</p>
                      </div>
                    </div>
                  </Card>
                </div>
                ...
                <div className="bg-gradient-primary text-primary-foreground p-6 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm">
                    <div className="flex items-start space-x-2">
                      <Leaf className="mt-1 flex-shrink-0" size={16} />
                      <span>Approche unique alliant performance et durabilité</span>
                    </div>
                    <div className="flex items-start space-x-2">
                      <MessageSquare className="mt-1 flex-shrink-0" size={16} />
                      <span>25+ années d'expérience combinée</span>
                    </div>
                    <div className="flex items-start space-x-2">
                      <TrendingUp className="mt-1 flex-shrink-0" size={16} />
                      <span>100+ startups et PME accompagnées</span>
                    </div>
                  </div>
                </div>
              </div>
